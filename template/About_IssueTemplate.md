...
1. .github/ISSUE_TEMPLATET 폴더를 생성.

![image](https://user-images.githubusercontent.com/31919227/148311732-52dfe51c-7883-4b29-b78d-490f419145f2.png)


2. Issue 타입별 yaml 파일 생성
### bug.yml 
```
name: Bug
